...
- 각 요청의 계획 파일은 `docs/plan/{plan_id}/plan.yaml`에 저장됩니다.
...
## 최소 디렉터리 구조
- `docs/plan/_template/`: 템플릿 보관
- `docs/plan/{plan_id}/plan.yaml`: 실제 작업 계획

## 예시
- `docs/plan/sample-1axis-hybrid-flow/plan.yaml`
