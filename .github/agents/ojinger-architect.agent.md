...
<architect_checklist>
 ...
 Always generate and store UML diagrams (.mmd) in the designated architecture directory for both intent and as-built modes.
 Always use pyreverse for as-built architecture generation from Python code.
 Always reference architecture artifacts before planning, implementation, and review.
